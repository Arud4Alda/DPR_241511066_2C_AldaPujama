...
$routes->group('admin', ['filter' => 'adminauth'], function($routes) {
    ...
    $routes->get('penggajian/edit/(:segment)', 'Admin::editpenggajian/$1');
    $routes->post('penggajian/update', 'Admin::updatepenggajian');
...
$routes->group('client', ['filter' => 'clientauth'], function($routes) {
    ...
    $routes->get('penggajian/detail/(:segment)', 'Client::detailpenggajian/$1');
});